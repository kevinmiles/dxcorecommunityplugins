...
Public Class ReferenceListItem
    ...
    Public Property Reference() As Reference
        ...
        End Set
    End Property
    Public Shared Function [Of](ByVal Reference As Reference) As ReferenceListItem
        Return New ReferenceListItem With {.Reference = Reference}
    End Function
    Public Shared Function [Of](ByVal Reference As String) As ReferenceListItem
        Return New ReferenceListItem With {.Reference = New Reference(Reference)}
    End Function
End Class
Module StringExt
    <Extension()> _
