...
Public Class XPO_EasyFields_Options
    ...
    Public Const STR_ClassNameOnly As String = "ClassNameOnly"
...
#End Region
    ...
    Private Sub XPO_EasyFields_Options_CommitChanges(ByVal sender As Object, ByVal ea As DevExpress.CodeRush.Core.CommitChangesEventArgs) Handles Me.CommitChanges
        ea.Storage.WriteBoolean(STR_Setting, STR_ClassNameOnly, chkClassNameOnly.Checked)
    ...
    Private Sub XPO_EasyFields_Options_PreparePage(ByVal sender As Object, ByVal ea As DevExpress.CodeRush.Core.OptionsPageStorageEventArgs) Handles Me.PreparePage
        chkClassNameOnly.Checked = ea.Storage.ReadBoolean(STR_Setting, STR_ClassNameOnly)
        UpdateDisplay()
    ...
    Private Sub chkRegion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkClassNameOnly.CheckedChanged
        UpdateDisplay()
    End Sub
