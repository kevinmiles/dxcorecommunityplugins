...
{
	/// <summary>
	/// Compares <see cref="LinePair"/> objects in a case-insensitive fashion.
	/// </summary>
	public class CaseInsensitiveLineComparer : LineComparer
	{
		...
		public override int Compare(object x, object y) {
			...
			return String.Compare(xpair.SortableLine, ypair.SortableLine, true);
		}
