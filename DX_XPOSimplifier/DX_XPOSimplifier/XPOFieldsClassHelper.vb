...
Public Class XPOFieldsClassHelper
...
#End Region
    ...
    Public Sub CreateXPOSimplifier()
        ...
        XPOSimplifier.ProviderName = "XPOFieldsClassHelper" ' Should be Unique
    ...
    Private Sub XPOSimplifier_CheckAvailability(ByVal sender As Object, ByVal ea As CheckContentAvailabilityEventArgs)
        ...
        If TypeOf ea.CodeActive Is ITypeElement AndAlso DXCoreXPOHelper.XPOElement.Check(Of DevExpress.Xpo.PersistentBase)(ea.CodeActive) Then
            ea.Available = True
            Return
        End If
        ea.Available = False
                ...
                While element.MoveNext
                    ...
                    If FoundMember IsNot Nothing Then
                        If DXCoreXPOHelper.IsPersistentMember(FoundMember) Then
                            ...
                            Else
                                newPropertyType = GetType(DevExpress.Data.Filtering.OperandProperty).FullName
                            End If
