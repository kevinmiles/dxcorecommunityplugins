...
Public Module CodeIssuesExt
    ...
    End Sub
    <Extension()> _
    Public Sub Add(ByVal Source As CheckCodeIssuesEventArgs, ByVal Style As StyleEnum, ByVal ElementType As LanguageElementType, ByVal Proc As System.Func(Of LanguageElement, Boolean), ByVal Message As String)
        Dim Elements = GetElements(Source.Scope, ElementType, Proc)
        For Each element As LanguageElement In Elements
            Select Case Style
                Case StyleEnum.Hint
    ...
    Private Function GetElements(ByVal Scope As IElement, ByVal ElementType As LanguageElementType, ByVal Proc As System.Func(Of LanguageElement, Boolean)) As IEnumerable(Of LanguageElement)
        Return New ElementEnumerable(Scope, New ElementTypeFilter(ElementType), True) _
                    .OfType(Of LanguageElement)().Where(Proc)
    End Function
End Module