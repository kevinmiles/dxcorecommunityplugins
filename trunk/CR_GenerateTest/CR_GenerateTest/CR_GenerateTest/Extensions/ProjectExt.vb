...
Public Module ProjectElementExt
    ...
    End Function
    <Extension()> _
    Public Function GetTypeWithFullname(ByVal ParentProject As ProjectElement, ByVal Fullname As String) As TypeDeclaration
        Return ParentProject.FirstTypeWhere(Function(x) x.FullName = Fullname)
    End Function
