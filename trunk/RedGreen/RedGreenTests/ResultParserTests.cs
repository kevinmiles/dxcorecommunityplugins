...
namespace RedGreenTests
{
    public class ResultParserTests
    {
        ...
        public void ResultSplitter()
        {
            ...
            ResultParser underTest = new ResultParser();

            result = new StringBuilder();
            underTest.ReadNextTextResult(reader, ref line, result);
        ...
        public void ResultIsTest()
        {
            ...
            Assert.True(underTest.IsTestResult(rawResult));
        }
        ...
        public void ResultIsNotTest()
        {
            ...
            Assert.False(underTest.IsTestResult("[failed] Fixture MbUnit v3.0.5.546/RedGreenPlayground/MbUnitTests\n"));
            Assert.False(underTest.IsTestResult("[failed] Assembly MbUnit v3.0.5.546/RedGreenPlayground\n"));
            Assert.False(underTest.IsTestResult("[failed] Framework MbUnit v3.0.5.546\n"));
        }
        ...
        public void ResultIsSummary()
        {
            ...
            Assert.True(underTest.IsRootResult(rawResult));
        }
        ...
        public void DisectSummary()
        {
            ...
            SummaryResult result = underTest.ParseSummary(rawResult);
